describe("all tags", function () {
  ...
  it("lists all tags with many posts", async function () {
    ...
    expect(body.trim()).toEqual(
      "<ul><li>tag0 100</li><li>tag1 80</li><li>tag2 60</li><li>tag3 40</li><li>tag4 20</li><li>tag95 20</li><li>tag96 40</li><li>tag97 60</li><li>tag98 80</li><li>tag99 100</li></ul>",
    );
  }, 30000);
});

describe("render", function () {
  ...
  it("minifies css", async function () {
    ...
    expect(res.status).toEqual(200);
    expect(body.trim()).toEqual(
      "body{background-color:#add8e6}h1{color:#fff;text-align:center}",
    );
  });

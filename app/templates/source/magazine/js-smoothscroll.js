    ...
    return function (a, d) {
      ...
      (S.cancelScroll = function () {
        ...
        (S.animateScroll = function (t, a, r) {
          ...
          if (d || h) {
            var g = e.pageYOffset;
            f.header && !p && (p = document.querySelector(f.header)),
              v || (v = s(p));
            var b,
              y,
              E,
              I = d
                ...
                : c(
                    ...
                    v,
                    parseInt(
                      "function" == typeof f.offset ? f.offset() : f.offset,
                      10,
                    ),
                  ),
              O = I - g,
              ...
              w = function (n, o) {
                var r = e.pageYOffset;
                if (n == o || r == o || (g < o && e.innerHeight + r) >= A)
                  return (
                    S.cancelScroll(), l(t, o, d), f.after(t, a), (b = null), !0
                  );
              },
              Q = function (t) {
                b || (b = t),
                  ...
                  w(E, I) || (e.requestAnimationFrame(Q), (b = t));
              };
          ...
          if (
            ...
            (h = document.querySelector(n)),
              h &&
                ...
                (h.id = ""),
                g.hash === e.location.hash && (t.preventDefault(), E()));
          }
        },
        O = function (e) {
          b ||
      ...
      return (
        ...
        (S.init = function (a) {
          t &&
            (S.destroy(),
            (m = o(n, a || {})),
            (p = m.header ? document.querySelector(m.header) : null),
            (v = s(p)),

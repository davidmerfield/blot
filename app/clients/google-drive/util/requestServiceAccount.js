...
module.exports = async function () {
  ...
  serviceAccounts.sort((a, b) => {
    const freeSpaceA =
      parseInt(a.storageQuota.limit) - parseInt(a.storageQuota.usage);
    const freeSpaceB =
      parseInt(b.storageQuota.limit) - parseInt(b.storageQuota.usage);
  ...
  const selectedFreeSpace =
    serviceAccounts[0].storageQuota.limit -
    serviceAccounts[0].storageQuota.usage;

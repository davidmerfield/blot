...
const getPickerElement = () =>
  document.querySelector("[data-template-font-picker]");
...
Array.from(document.querySelectorAll("[data-font-picker-form]")).forEach(
  (form) => {
    ...
    trigger.addEventListener("blur", (event) => {
      ...
      if (
        ...
        (trigger.contains(next) ||
          (pickerElement && pickerElement.contains(next)))
      ) {
        return;
      }
      scheduleHide();

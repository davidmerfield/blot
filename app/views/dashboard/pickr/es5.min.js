  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      var n = r(0),
        ...
        ot = function (t, e) {
          ...
          return (
            V(r, { type: "Symbol", tag: t, description: e }),
            c || (r.description = e),
            r
          );
        },
      ...
      n({ global: !0, wrap: !0, forced: !u, sham: !u }, { Symbol: U }),
      F(x(tt), function (t) {
        N(t);
      }),
      n(
      ...
      U.prototype[H] || C(U.prototype, H, U.prototype.valueOf),
        M(U, "Symbol"),
        (R[B] = !0);
    },
    function (t, e, r) {
            ...
            [
              ...
              function (t, o) {
                ...
                for (var x = 0, S = 0, w = []; S < p.length; ) {
                  ...
                  if (
                    null === A ||
                    (_ = h(s(b.lastIndex + (d ? 0 : S)), p.length)) === x
                  )
                    S = u(p, S, g);
                  else {
    ...
    function (t, e, r) {
      ...
      var n = r(0),
        o = r(140).start;
      n(
        { target: "String", proto: !0, forced: r(141) },
        {
          padStart: function (t) {
            return o(this, t, arguments.length > 1 ? arguments[1] : void 0);
          },
      ...
      n(
        {
          target: "Array",
          proto: !0,
          forced: !r(14)("indexOf", { ACCESSORS: !0, 1: 0 }),
        },
        {
          includes: function (t) {
            return o(this, t, arguments.length > 1 ? arguments[1] : void 0);
    ...
    function (t, e, r) {
      ...
      var n = r(0),
        ...
        f = r(14),
        p = l("splice"),
        v = f("splice", { ACCESSORS: !0, 0: 0, 1: 2 }),
        h = Math.max,
        d = Math.min;
      n(
          ...
          splice: function (t, e) {
            ...
            if (
              (0 === m
                ...
                : 1 === m
                  ? ((r = 0), (n = y - b))
                  : ((r = m - 2), (n = d(h(i(e), 0), y - b))),
              y + r - n > 9007199254740991)
            )
              throw TypeError("Maximum allowed length exceeded");
            for (l = u(g, n), f = 0; f < n; f++)
              (p = b + f) in g && s(l, f, g[p]);
            if (((l.length = n), r < n)) {
              for (f = b; f < y - n; f++)
                (v = f + r), (p = f + n) in g ? (g[v] = g[p]) : delete g[v];
              for (f = y; f > y - n + r; f--) delete g[f - 1];
            } else if (r > n)
              for (f = y - n; f > b; f--)
                (v = f + r - 1),
                  (p = f + n - 1) in g ? (g[v] = g[p]) : delete g[v];
    ...
    function (t, e, r) {
      r(0)({ target: "String", proto: !0 }, { repeat: r(67) });
    },
    function (t, e, r) {
      var n = r(99);
      t.exports = function (t) {
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (
            ...
            (v = b ? i(f, y, [l.value, x], !0) : l.value), u(r, x, v);
        return (r.length = x), r;
      };
    },
    function (t, e, r) {
        ...
        { target: "Array", proto: !0, forced: !v || !h },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return g.call(f, v, h);
            for (
              n = new (void 0 === r ? Array : r)(y(h - v, 0)), l = 0;
              v < h;
              v++, l++
            )
              v in f && s(n, l, f[v]);
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var _, A = "", O = 0, E = 0; E < S.length; E++) {
              ...
              for (
                var C = String(w[0]),
                  k = f(p(c(w.index), v.length), 0),
                  j = [],
                  P = 1;
                P < w.length;
                P++
              )
                j.push(void 0 === (_ = w[P]) ? _ : String(_));
              var R = w.groups;
              if (h) {
    ...
    function (t, e, r) {
      ...
      var n = r(0),
        o = r(92).trim;
      n(
        { target: "String", proto: !0, forced: r(139)("trim") },
        {
          trim: function () {
            return o(this);
          },
        ...
        },
        {
          toFixed: function (t) {
            var e,
              ...
              d = function (t, e) {
                for (var r = -1, n = e; ++r < 6; )
                  (n += t * p[r]), (p[r] = n % 1e7), (n = s(n / 1e7));
              },
              g = function (t) {
                for (var e = 6, r = 0; --e >= 0; )
                  (r += p[e]), (p[e] = s(r / t)), (r = (r % t) * 1e7);
              },
              y = function () {
                for (var t = 6, e = ""; --t >= 0; )
                  if ("" !== e || 0 === t || 0 !== p[t]) {
    ...
    function (t, e, r) {
          ...
          if ((e = r[o].exec(t))) {
            ...
            switch (o) {
              case "cmyk":
                ...
                return { values: _(c, u, s, l), type: o };
              case "rgba":
                var f = n(e),
                  p = f[3],
                  v = f[4],
                ...
                if (p > 255 || v > 255 || h > 255 || d < 0 || d > 1 || !i(d))
                  break t;
                return { values: [].concat(w(p, v, h), [d]), a: d, type: o };
              case "hexa":
                var g = e[1];
                ...
                return (
                  ...
                  { values: [].concat(O(y), [b]), a: b, type: o }
                );
              case "hsla":
                var m = n(e),
                  x = m[3],
                  ...
                  E = m[5],
                  C = m[6];
                if (x > 360 || S > 100 || E > 100 || C < 0 || C > 1 || !i(C))
                  break t;
                return { values: [].concat(A(x, S, E), [C]), a: C, type: o };
              case "hsva":
                var k = n(e),
                  j = k[3],
                  P = k[4],
                  R = k[5],
                  I = k[6];
                if (j > 360 || P > 100 || R > 100 || I < 0 || I > 1 || !i(I))
                  break t;
                return { values: [j, P, R, I], a: I, type: o };
            }
          }
        ...
        var e = {
              ...
              if (document.activeElement === r.wrapper) {
                ...
                if ("keydown" === n && (a || c || u || s)) {
                  ...
                  "v" === i
                    ...
                    e.update(k(e.cache.x + 0.01 * l), k(e.cache.y + 0.01 * f)),
                    t.preventDefault();
                } else
                  o.startsWith("Arrow") &&
            ...
            destroy: function () {
              ...
              s(document, ["keydown", "keyup"], n),
                s([t.wrapper, t.element], "mousedown", r),
                s([t.wrapper, t.element], "touchstart", r, { passive: !1 });
            },
          },
          r = e.options,
          n = e._tapstart,
      ...
      function R(t) {
        var e,
          ...
          o = t.padding,
          i = void 0 === o ? 8 : o,
          a = { start: "sme", middle: "mse", end: "ems" },
          c = { top: "tbrl", right: "rltb", bottom: "btrl", left: "lrbt" },
          u =
            (void 0 === e && (e = {}),
            function (t, r) {
              ...
              var n = t.split("-"),
                ...
                a = void 0 === i ? "middle" : i,
                c = "top" === o || "bottom" === o;
              return (e[t] = { position: o, variant: a, isVertical: c });
            });
        return {
          update: function (t, e) {
            void 0 === e && (e = !1);
            for (
              var o = u(t),
                ...
                h = function (t) {
                  return t
                    ? { t: p.top - v.height - i, b: p.bottom + i }
                    : { r: p.right + i, l: p.left - v.width - i };
                },
                d = function (t) {
                  return t
                    ? {
            ...
            e
              ? ((r.style.top = (window.innerHeight - v.height) / 2 + "px"),
                (r.style.left = (window.innerWidth - v.width) / 2 + "px"))
              : ((r.style.left = g.left), (r.style.top = g.top));
          },
        };
      }
      function I(t, e, r) {
      ...
      var L = (function () {
        function t(t) {
          ...
          var r = t,
            ...
            c = r.lockOpacity,
            u = r.padding;
          ["nano", "monolith"].includes(i) && !a && (t.sliders = "h"),
          ...
          var v = this._root,
            h = v.button,
            d = v.app;
          (this._nanopop = R({ reference: h, padding: u, el: d })),
            h.setAttribute("role", "button"),
            h.setAttribute("aria-label", "toggle color picker dialog");
          var g = this;
          requestAnimationFrame(function e() {
            if (!d.offsetWidth && d.parentElement !== t.container)
              return requestAnimationFrame(e);
            g.setColor(t.default),
              g._rePositioningPicker(),
              t.defaultRepresentation &&
                ((g._representation = t.defaultRepresentation),
                g.setColorRepresentation(g._representation)),
              t.showAlways && g.show(),
              (g._initializingActive = !1),
              g._emit("init");
          });
        }
        var e = t.prototype;
        return (
          (e._preBuild = function () {
            ...
            (this._root =
              ...
              s)),
              f.useAsButton && (this._root.button = f.el),
              f.container.appendChild(this._root.root);
          }),
                    ...
                    if (r.palette) {
                      ...
                      (this.element.style.background = f),
                        (this.wrapper.style.background =
                          ...
                          "))\n                    "),
                        a.comparison
                          ? a.useAsButton || e._lastColor || (s.style.color = f)
                      ...
                      for (v = h ? v : v[Symbol.iterator](); ; ) {
                        ...
                        var y = g,
                          ...
                          m = y.color;
                        b.classList[
                          p === m.toHEXA().toString() ? "add" : "remove"
                        ]("pcr-active");
                      }
                      l.style.color = f;
                    }
          ...
          (e._updateOutput = function () {
            ...
            if (t.interaction.type()) {
              ...
              t.interaction.result.value =
                "function" == typeof e[n]
                  ? e[n]().toString(r.outputPrecision)
                  : "";
            }
          ...
          (e.applyColor = function (t) {
            ...
            return (
              (r.lastColor.style.color = o),
              this.options.useAsButton || (n.style.color = o),
      ...
      (L.utils = n),
        (L.libs = { HSVaColor: C, Moveable: j, Nanopop: R, Selectable: P }),
        (L.create = function (t) {
          return new L(t);
        }),
        (L.version = g.a);

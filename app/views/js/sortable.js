...
!(function (a) {
  ...
  function a(a, b) {
    ...
    var g = b.group;
    (g && "object" == typeof g) || (g = b.group = { name: g }),
      ...
      do
        if (
          ...
          (("" === d || a.nodeName.toUpperCase() == d) &&
            (!b.length ||
              ((" " + a.className + " ").match(e) || []).length == b.length))
        )
          return a;
  ...
  function i(a, b, c) {
    ...
    if (d) {
      if (void 0 === c)
        return (
          G.defaultView && G.defaultView.getComputedStyle
            ? (c = G.defaultView.getComputedStyle(a, ""))
  ...
  var q,
    ...
    C,
    D = {},
    E = "Sortable" + new Date().getTime(),
    F = window,
    G = F.document,
    H = F.parseInt,
    I = !!G.createElement("div").dragDrop,
    J = !1,
    ...
    L = "onAdd onUpdate onRemove onStart onEnd onFilter onSort".split(" "),
    M = function () {},
    N = Math.abs,
    O = [].slice,
    P = [];
    ...
    (a.prototype = {
      ...
      _onTapStart: function (a) {
        ...
        if (!(("mousedown" === b && 0 !== a.button) || h.disabled)) {
          if (
            (h.handle && (e = d(e, h.handle, i)),
            (e = d(e, h.draggable, i)),
            (y = o(e)),
            "function" == typeof l)
          ) {
            if (l.call(this, a, e, this))
              return K(g, "filter", e, i, y), void a.preventDefault();
          } else if (
            l &&
            (l = l.split(",").some(function (a) {
              return (
                (a = d(g, a.trim(), i)),
                a ? (K(a, "filter", e, i, y), !0) : void 0
              );
            }))
          )
            return void a.preventDefault();
          if (e && !q && e.parentNode === i) {
            "selectstart" === b && e.dragDrop(),
              (B = a),
              (t = this.el),
              (q = e),
              (v = q.nextSibling),
              (A = this.options.group),
              (q.draggable = !0),
              h.ignore.split(",").forEach(function (a) {
                j(e, a.trim(), k);
              }),
              c &&
                ((B = { target: e, clientX: c.clientX, clientY: c.clientY }),
                this._onDragStart(B, !0),
                a.preventDefault()),
              f(G, "mouseup", this._onDrop),
              f(G, "touchend", this._onDrop),
              f(G, "touchcancel", this._onDrop),
              f(q, "dragend", this),
      ...
      _emulateDragOver: function () {
        if (C) {
          i(r, "display", "none");
          var a = G.elementFromPoint(C.clientX, C.clientY),
            b = a,
      ...
      _onTouchMove: function (a) {
        if (B) {
          var b = a.touches[0],
            c = b.clientX - B.clientX,
            d = b.clientY - B.clientY,
      ...
      _onDragStart: function (a, b) {
        ...
        if (
          ...
          var e,
            ...
            h = i(q);
          (r = q.cloneNode(!0)),
            i(r, "top", g.top - H(h.marginTop, 10)),
            i(r, "left", g.left - H(h.marginLeft, 10)),
            i(r, "width", g.width),
            i(r, "height", g.height),
            i(r, "opacity", "0.8"),
            i(r, "position", "fixed"),
            ...
            f(G, "touchmove", this._onTouchMove),
            f(G, "touchend", this._onDrop),
            f(G, "touchcancel", this._onDrop),
        ...
        if (t && this.options.scroll) {
          ...
          k || l
            ...
            : u &&
              ...
              (k = (N(c.right - g) <= e) - (N(c.left - g) <= e)),
              (l = (N(c.bottom - h) <= e) - (N(c.top - h) <= e))),
            (D.vx !== k || D.vy !== l || D.el !== b) &&
              ((D.el = b),
              (D.vx = k),
              (D.vy = l),
              clearInterval(D.pid),
              b &&
                (D.pid = setInterval(function () {
                  b === F
                    ? F.scrollTo(F.scrollX + k * f, F.scrollY + l * f)
                    : (l && (b.scrollTop += l * f),
                      k && (b.scrollLeft += k * f));
                }, 24)));
        }
      ...
      _onDragOver: function (a) {
        ...
        if (
          (void 0 !== a.preventDefault &&
            (a.preventDefault(), !h.dragoverBubble && a.stopPropagation()),
          !J &&
            A &&
            (n
              ? o || (f = !t.contains(q))
              : A.pull &&
                k &&
                (A.name === j.name || (k.indexOf && ~k.indexOf(A.name)))) &&
            (void 0 === a.rootEl || a.rootEl === this.el))
        ) {
          if (
            ((c = d(a.target, h.draggable, g)),
            (e = q.getBoundingClientRect()),
            f)
          )
            return (
              b(!0),
              void (s || v ? t.insertBefore(q, s || v) : o || t.appendChild(q))
            );
          if (
            0 === g.children.length ||
            g.children[0] === r ||
            ...
            var p,
              ...
              y = u.right - u.left,
              z = u.bottom - u.top,
              B = /left|right|inline/.test(x.cssFloat + x.display),
              C = c.offsetWidth > q.offsetWidth,
              D = c.offsetHeight > q.offsetHeight,
              F =
                (B ? (a.clientX - u.left) / y : (a.clientY - u.top) / z) > 0.5,
              G = c.nextElementSibling;
            (J = !0),
              setTimeout(l, 30),
              b(n),
              (p = B
                ? (c.previousElementSibling === q && !C) || (F && C)
                : (G !== q && !D) || (F && D)),
              p && !G
                ? g.appendChild(q)
                : c.parentNode.insertBefore(q, p ? G : c),
              this._animate(e, q),
              this._animate(u, c);
          }
        }
      ...
      _offUpEvents: function () {
        g(G, "mouseup", this._onDrop),
          g(G, "touchmove", this._onTouchMove),
          g(G, "touchend", this._onDrop),
          g(G, "touchcancel", this._onDrop);
      },
      _onDrop: function (b) {
        var c = this.el,
          d = this.options;
              ...
              t !== q.parentNode
                ...
                : (s && s.parentNode.removeChild(s),
                  q.nextSibling !== v &&
                    ...
                    K(t, "update", q, t, y, z),
                    K(t, "sort", q, t, y, z))),
              a.active && K(t, "end", q, t, y, z)),
            (t = q = r = v = s = B = C = w = x = A = a.active = null),
            this.save());
      },
      ...
      toArray: function () {
        for (
          var a, b = [], c = this.el.children, e = 0, f = c.length;
          f > e;
          e++
        )
          (a = c[e]),
            d(a, this.options.draggable, this.el) &&
              b.push(a.getAttribute("data-id") || n(a));
        return b;
      },
      sort: function (a) {
        var b = {},
      ...
      destroy: function () {
        ...
        L.forEach(function (c) {
          ...
          g(a, "selectstart", this._onTapStart),
          g(a, "dragover", this._onDragOver),
          g(a, "dragenter", this._onDragOver),
